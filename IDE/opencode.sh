#!/bin/bash
# opencode.sh - Instalación de OpenCode AI CLI/Editor para Fedora 44

set -euo pipefail

OPENCODE_VERSION="${1:-1.18.13}"

echo "Instalando OpenCode (Version: $OPENCODE_VERSION)..."
...
echo "Descargando instalador de OpenCode..."
curl -fsSL https://opencode.ai/install -o "$TMP_INSTALLER"

echo "Ejecutando instalador para versión $OPENCODE_VERSION..."
