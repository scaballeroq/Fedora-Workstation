#!/bin/bash
# ==============================================================================
# nodejs.sh - Instalación de Node.js (Última LTS) vía Mise para Fedora Workstation
# Optimizado para GNOME y Zsh/Bash (npm, pnpm, yarn vía Corepack)
# ==============================================================================

set -euo pipefail

echo "================================================================="
echo "🟢 Instalando Node.js (Última versión LTS) para Fedora Workstation"
echo "================================================================="
...
$SUDO dnf5 install -y @development-tools gcc-c++ make curl python3 libstdc++-devel 2>/dev/null || true
...
echo "================================================================="
echo "✅ Node.js LTS configurado con éxito para Fedora Workstation y Zsh/Bash:"
echo "  • Node.js:  $NODE_VER (LTS)"
echo "  • npm:      $NPM_VER"
echo "  • pnpm:     $PNPM_VER"
echo "  • yarn:     $YARN_VER"
echo "  • Entorno:  GNOME + Shells (~/.local/share/mise/shims)"
echo "================================================================="
